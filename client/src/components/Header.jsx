        ...
        {user ? (
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 w-48 bg-white bg-transparent backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4"
                >
                  <Link
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                {...ButtonClick}
                className="px-4 py-2 rounded-md shadow-md bg-slate-100 bg-transparent border border-red-300 cursor-pointer"
              >
                Login
              </motion.button>
            </NavLink>
